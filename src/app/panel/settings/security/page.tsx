  ...
  return (
    <main id="panel-security-page" className="mx-auto w-full max-w-3xl px-6 py-8">
      <header id="panel-security-header" className="mb-6">
        ...
        <p
          id="panel-security-subtitle"
          className="mt-1 text-sm [color:var(--text-subtle,var(--muted-foreground))]"
        >
      ...
      <div
        id="panel-security-card"
        className="rounded-2xl border border-border p-6 [background:var(--surface-2,var(--card))]"
      >
        <p
          id="panel-security-text"
          className="text-sm [color:var(--text-subtle,var(--muted-foreground))]"
        >
